    ...
    return (
        <div className="container">
            ...
            {myBookings.map( booking => {
                return (
                    <div key={booking.id} className="col-12 col-sm-6 col-md-4 col-xl-3 d-flex align-items-center justify-content-center mb-3">
                    <div className="text-left card shadow">
                        <button className="btn btn-outline-dark border-0 bg-transparent align-self-start" onClick={() => onClickDelete(booking.id)}>
