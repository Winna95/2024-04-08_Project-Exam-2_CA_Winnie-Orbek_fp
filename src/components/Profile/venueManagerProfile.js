...
import {getMyVenues} from "../../js/profile-api";
...
/**
 * ProfileVenueManager component for the Holidaze Booking application.
 * This component displays venues managed by the current user, allows editing and deleting venues,
 * and shows bookings associated with each venue.
 * @returns {JSX.Element} The rendered venue manager profile component.
 */
        ...
        <div className="container">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-12 mb-4" key={venue.id}>
                            <div className="card h-100 mx-auto d-flex flex-column shadow">
                                <div className="d-flex mb-2">
                                    ...
                                    <button className="btn btn-outline-dark border-0 bg-transparent align-self-start"
                                            onClick={() => onClickDelete(venue.id)}>
                                        <FontAwesomeIcon icon={faTrashAlt}/>
                                    </button>
                                </div>
                                <img className="card-img-top object-fit-cover" src={venue.media[0].url}
                                     alt={venue.name}/>
                                <div className="card-body d-flex flex-column justify-content-between">
                                    ...
                                    <div className="text-center my-4">
                                        <button className="btn-blue border-0 text-white px-5 py-2 rounded-0 fw-medium"
                                                onClick={() => {
                                                    onClickShowBooking(venue)
                                                }}>
            ...
            <div className="text-center mt-4">
                ...
                <div className="btn my-2">
                    <button className="btn-blue border-0 text-white px-5 py-2 rounded-0 fw-medium"
                            onClick={() => setShowCreateVenueForm(true)}>Create new venue
                    </button>
                </div>
            </div>
